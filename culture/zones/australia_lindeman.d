module culture.zones.australia_lindeman;
...
public:
	...
	long savings(long year, Month month, uint day, uint hour, uint minute) {
		...
		else if (Util.isStrictlyBefore(year, month, day, hour, minute, 1992, 7, 1,0,0)) {
			return AustralasiaRules.AqRule.savings(year, month, day, hour, minute);
		}
		else if (Util.isStrictlyBefore(year, month, day, hour, minute, 3200000, 1, 1,0,0)) {
			return AustralasiaRules.HolidayRule.savings(year, month, day, hour, minute);
		}
