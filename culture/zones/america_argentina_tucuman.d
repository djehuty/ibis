module culture.zones.america_argentina_tucuman;
...
class AmericaArgentinaTucumanZone {
static:
public:
	...
	long savings(long year, Month month, uint day, uint hour, uint minute) {
		...
		else if (Util.isStrictlyBefore(year, month, day, hour, minute, 1991, 3, 3,0,0)) {
			return SouthamericaRules.ArgRule.savings(year, month, day, hour, minute);
		}
		else if (Util.isStrictlyBefore(year, month, day, hour, minute, 1991, 10, 20,0,0)) {
			return 0;
		}
		...
		else if (Util.isStrictlyBefore(year, month, day, hour, minute, 2004, 6, 1,0,0)) {
			return 0;
		}
		else if (Util.isStrictlyBefore(year, month, day, hour, minute, 2004, 6, 13,0,0)) {
			return 0;
		}
