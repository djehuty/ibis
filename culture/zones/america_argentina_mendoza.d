module culture.zones.america_argentina_mendoza;
...
class AmericaArgentinaMendozaZone {
static:
public:
	...
	long savings(long year, Month month, uint day, uint hour, uint minute) {
		...
		else if (Util.isStrictlyBefore(year, month, day, hour, minute, 1991, 10, 15,0,0)) {
			return 0;
		}
		else if (Util.isStrictlyBefore(year, month, day, hour, minute, 1992, 3, 1,0,0)) {
			return 0;
		}
		else if (Util.isStrictlyBefore(year, month, day, hour, minute, 1992, 10, 18,0,0)) {
			return 0;
		}
		...
		else if (Util.isStrictlyBefore(year, month, day, hour, minute, 2004, 5, 23,0,0)) {
			return 0;
		}
		else if (Util.isStrictlyBefore(year, month, day, hour, minute, 2004, 9, 26,0,0)) {
			return 0;
		}
