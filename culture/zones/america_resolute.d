module culture.zones.america_resolute;
...
class AmericaResoluteZone {
static:
public:
	
	long savings(long year, Month month, uint day, uint hour, uint minute) {
		if (Util.isStrictlyBefore(year, month, day, hour, minute, 1947, 8, 31,0,0)) {
			return 0;
		}
		...
		else if (Util.isStrictlyBefore(year, month, day, hour, minute, 2006, 10, 29,2,0)) {
			return NorthamericaRules.CanadaRule.savings(year, month, day, hour, minute);
		}
		else if (Util.isStrictlyBefore(year, month, day, hour, minute, 3200000, 1, 1,0,0)) {
			return NorthamericaRules.ResoluteRule.savings(year, month, day, hour, minute);
		}
