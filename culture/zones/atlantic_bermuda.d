module culture.zones.atlantic_bermuda;
...
class AtlanticBermudaZone {
static:
public:
	
	long savings(long year, Month month, uint day, uint hour, uint minute) {
		if (Util.isStrictlyBefore(year, month, day, hour, minute, 1930, 1, 1,2,0)) {
			return 0;
		}
			...
			return NorthamericaRules.BahamasRule.savings(year, month, day, hour, minute);
		}
