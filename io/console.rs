...
pub mod io {
  pub mod console {
    ...
    pub struct Console {
      foreground: ::drawing::color::Color,
      background: ::drawing::color::Color
    }

    fn nearestXtermColor(color: ::drawing::color::Color) -> u32 {
      ...
      for i in iter::range_step(0_u32, 256, 1) {
        ...
        let blue  = ((comparedColor >>  0) & 0xff) as f64 / 255_f64;

        // Compare euclidian distance
        let mut distance = 0.0;
        let mut intermediate;

        intermediate  = red - color.red();
        intermediate *= intermediate;

        distance += intermediate;

        intermediate  = green - color.green();
        intermediate *= intermediate;
    ...
    impl Console {
      pub fn print(&self, string: &str) {
        let fgcolor = nearestXtermColor(self.foreground);
        let bgcolor = nearestXtermColor(self.background);

        ::io::console::print("\x1b[38;5;");
        ::io::console::print(::text_format::text::format::integer(fgcolor as i64, 10));
        ::io::console::print("m\x1b[48;5;");
        ::io::console::print(::text_format::text::format::integer(bgcolor as i64, 10));
        ::io::console::print("m");
        ::io::console::print(string);
      }
